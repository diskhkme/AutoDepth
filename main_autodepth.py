...
from model import PointNet, DGCNN_cls, DGCNN_AutoDepth
import numpy as np
...
def train(args, io):
    ...
    if args.model == 'pointnet':
        ...
        model = DGCNN_AutoDepth(args).to(device)
    else:
...
if __name__ == "__main__":
    ...
    parser.add_argument('--num_view', type=int, default=1, metavar='N',
                        help='autodepth num_view')
    parser.add_argument('--num_subpoints_for_view_pred', type=int, default=128, metavar='N',
                        help='autodepth num_subpoints_for_view_pred')
    parser.add_argument('--projected_img_res', type=int, default=224, metavar='N',
                        help='pointcloud projected image resolution')
